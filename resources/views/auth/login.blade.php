...
<head>
    ...
    <title>User Login - Online Order Food</title>
    <!-- Favicon Icon -->
    <link rel="icon" type="{{ asset('frontend/image/png') }}" href="img/favicon.png">
    <!-- Bootstrap core CSS-->
                        ...
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-outline-primary btn-block btn-login text-uppercase font-weight-bold mb-2">Login</button>
                                    <div class="text-center pt-3">
                                        Don’t have an account? <a class="font-weight-bold" href="{{ route('register') }}">Register</a>
                                    </div>
                                </form>
                                <hr class="my-4">
