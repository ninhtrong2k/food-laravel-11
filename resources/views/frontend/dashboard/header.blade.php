            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
               <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <img alt="Generic placeholder image" src="{{ !empty(auth()->user()->photo) ? asset(auth()->user()->photo) : asset('upload/no_image.jpg') }}" class="nav-osahan-pic rounded-pill"> My Account
                     </a>
